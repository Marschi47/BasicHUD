...
public class MyModConfig {
    ...
    public static void loadConfig() {
        try {
            ...
            fpsColor = config.getString("fpsColor", "HUD_FPS", "FFFFFF", "Hex color code (e.g. FF0000 for red)");
            ...
            pingColor = config.getString("pingColor", "HUD_PING", "FFFFFF", "Hex color code");
            ...
            cpsColor = config.getString("cpsColor", "HUD_CPS", "FFFFFF", "Hex color code (e.g. FF0000 for red)");
