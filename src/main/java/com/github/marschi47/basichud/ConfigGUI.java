...
public class ConfigGUI extends GuiConfig {
    ...
    private static List<IConfigElement> getConfigElements() {
        ...
        keyList.add(new ConfigElement(
                cfg.get("HUD_Keystrokes", "KeystrokesEnabled", true, "If Keystrokes should be displayed")));
        keyList.add(new ConfigElement(
                cfg.get("HUD_Keystrokes", "keystrokesColor", "FFFFFF", "Color of Keystrokes Display (Hex Code)")));
        keyList.add(new ConfigElement(cfg.get("HUD_Keystrokes", "keystrokesActivatedColor", "00FF00",
                "Color of Keystrokes Display when activated (Hex Code)")));
        ...
        // keysrtokes button
        list.add(new DummyConfigElement.DummyCategoryElement("Keystrokes Settings", "basichud.config.keystrokes",
                keyList));

        // potion list
        List<IConfigElement> potionList = new ArrayList<>();
        potionList.add(
                new ConfigElement(cfg.get("HUD_POTIONS", "potionHudEnabled", true, "If Potions should be displayed")));
